...
public interface DepartmentService {
	String DEFAULT_NAME = "Default department";
	String DEFAULT_AREA = "Default area";

	/**
	 * It will return an existing department in the DB if it already exists, and in
	 * other case the department will be created before returning.
	 * 
	...
	/**
	 * Returns the department that has <code>DEFAULT_NAME</code> as its name and
	 * <code>DEFAULT_AREA</code> as its area.
	 * 
